<template>
  <div class="demo-test-area--wrapper" :style="{color: textColor}">
    ...
    <form class="demo-test-area" @submit.prevent="_handleSubmit" @keyup="_handleTyping">
      ...
      <textarea ref="textArea" class="demo-test-area--text" placeholder="Escribe un mensaje.... Oskie help" :style="textareaStyle" />
      <button class="demo-test-area--button" :style="{background: ctaColor, color: colors.sentMessage.text}"> Enviar mensaje! </button>
    </form>
